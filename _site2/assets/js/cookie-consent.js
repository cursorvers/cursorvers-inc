(function() {
  ...
  btn.textContent = 'OK';
  btn.style.cssText = 'background:#13243F;color:#FBFAF5;border:none;min-width:44px;min-height:44px;padding:8px 24px;border-radius:980px;font-size:14px;font-weight:600;cursor:pointer;white-space:nowrap';
