...
| 6 | 本アセスメント割引を段階制に変更する | `services.html`, `lib/advisor` |
...
- [x] 6. 本アセスメント割引を段階制に変更する（`services.html`, `lib/advisor`）
...
* どちらにせよ、**gov-lead.html と gov-lead.pdf を同一文言に修正**
  ([Cursorvers][2])
* さらに可能なら：PDFにも「アセスメント同時見積の5%OFF」等、Web側の条件を揃えて記載（またはWebから削る） ([Cursorvers][2])
...
- 箇条書き（3点、短く）
  ...
  3) `説明可能性：ガイドライン対応とアセスメント設計で“問われた時”に守る`
...
- 文言を以下に修正：
  - 医療機関向けカード本文：
    `院長・理事長の意思決定を代行補助し、導入〜運用〜教育〜アセスメントまで“事故なく回る体制”を整えます。`
  - ベンダー向けカード本文：
...
4) `継続レビュー・アセスメント`：定期レビュー／アセスメント設計で“説明できる体制”を維持
...
- title案：
  `Cursorvers｜院長・理事長のための医療AIコンサルティング（導入・運用・アセスメント）`
- description案：
  `忙しい院長・理事長の医療AI活用を、医師がベンダー中立で伴走。導入判断、ベンダー評価、運用設計、教育、アセスメントまで一貫支援。`
